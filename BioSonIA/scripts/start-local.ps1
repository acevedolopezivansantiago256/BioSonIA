...
StartProc "$root\backend" "$env:DISABLE_DB='true'; $env:AI_SERVICE_URL='http://localhost:5001'; $env:PORT='5000'; npm run dev"
StartProc "$root\frontend" "$env:NEXT_PUBLIC_BACKEND_URL='http://localhost:5000'; node ./node_modules/next/dist/bin/next dev -p 3000"
