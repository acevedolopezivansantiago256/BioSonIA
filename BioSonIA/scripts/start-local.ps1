...
StartProc "$root\backend" "$env:DISABLE_DB='true'; $env:AI_SERVICE_URL=('http://localhost:' + $ap); $env:PORT='5000'; npm run dev"
$fp = PickFrontPort
...
Write-Host ("AI:       http://localhost:{0}" -f $ap) -ForegroundColor Green
